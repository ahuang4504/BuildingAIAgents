...
class AgentState(TypedDict):
    ...
    - message_history: List of all conversation exchanges (set by call_llm node)
        Format: [{"user": "...", "llm": "..."}, ...]

    State Flow:
    1. Initial state: all fields empty/default
    2. After get_user_input: user_input and should_exit are populated
    3. After call_llm: llm_response and message_history are populated
...
def create_graph(llm):
    ...
    def get_user_input(state: AgentState) -> dict:
        ...
        if user_input:  # Only echo non-empty input
            print(f"\nYou: {user_input}")
    ...
    def call_llm(state: AgentState) -> dict:
        ...
        # Update history with clean response
...
def main():
    ...
    #   - call_llm populates llm_response and message_history
