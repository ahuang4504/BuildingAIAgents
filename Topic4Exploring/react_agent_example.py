...
def create_conversation_graph():
    ...
    model = ChatOpenAI(
        model="gpt-4o",
        temperature=0.7,
        openai_api_key="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"
    )
